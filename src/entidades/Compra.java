...
@NamedQueries({
    ...
    @NamedQuery(name = "Compra.findSinceFecha", query = "SELECT c FROM Compra c WHERE c.fecha >= :fecha ORDER BY c.fecha DESC"),
    @NamedQuery(name = "Compra.findSinceFechaAndIdProveedor", query = "SELECT c FROM Compra c WHERE c.idProveedor = :idProveedor AND c.fecha >= :fecha ORDER BY c.fecha DESC"),
